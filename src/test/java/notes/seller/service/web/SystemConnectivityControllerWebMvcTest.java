...
@TestPropertySource(properties = {
		...
		"app.storage.s3.bucket=notes",
		"app.storage.local.enabled=false"
})
class SystemConnectivityControllerWebMvcTest {
	@Autowired
	...
	@Test
	void connectivity_shouldReportStorageReachableWhenHeadBucketSucceeds() throws Exception {
	...
	@Test
	void connectivity_shouldReportStorageUnreachableWhenHeadBucketFails() throws Exception {
		when(s3Client.headBucket(any(HeadBucketRequest.class))).thenThrow(new RuntimeException("Connection refused"));
